  ...
  return (
    <div>
      <div className="flex items-center mb-6">
        ...
        <h1 className="bg-clip-text bg-gradient-to-r from-epic-purple to-epic-blue font-bold text-transparent text-2xl">Your Tasks</h1>
        <div className="flex items-center bg-black/5 ml-auto px-3 py-1 rounded-full text-sm">
          ...
          <span className="font-medium">Complete tasks to earn XP and level up!</span>
        </div>
      </div>
